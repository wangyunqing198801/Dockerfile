...
function monkcoder(){
    ...
    for jsname in $(find /monkcoder -name "*.js" | grep -vE "\/backup\/|z_health_energy.js|z_carnivalcity.js|z_mother_jump.js|z_xmf.js|z_health_community.js|monk_shop_follow_sku.js|monk_shop_add_to_car.js"); do cp ${jsname} /scripts/monkcoder_${jsname##*/}; done
}
